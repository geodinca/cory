...
/**
 * This is the model class for table "tbl_employees".
 *
 * The followings are the available columns in table 'tbl_employees':
 * @property integer $id
 ...
 * @property TblCompanies $companies
 * @property TblClients $clients
 */
class Employee extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('clients_id, companies_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, clients_id, companies_id, name, title, geographical_area, contact_info, email, home_street, home_city, home_state_country, home_zip, home_phone, actual_location_street, actual_location_city, actual_location_state, profile, date_entered, date_update, misc_info', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'companies' => array(self::BELONGS_TO, 'TblCompanies', 'companies_id'),
			'clients' => array(self::BELONGS_TO, 'TblClients', 'clients_id'),
		);
	}
